...
## Type: ShellCommand
c.fileselect.folder.command = ['terminology', '-e', 'lf', '{}']
...
## Type: ShellCommand
c.fileselect.single_file.command = ['terminology', '-e', 'lf', '{}']
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'https://www.dogpile.com/'
...
## qutebrowser`.
## Type: Dict
c.url.searchengines = {'DEFAULT': 'https://peekier.com/#!{}' ,'gt' : 'https://translate.google.com/#view=home&op=translate&sl=auto&tl=ru&text={}', 'rt' : 'https://peekier.com/#!site:rutracker.org {}','metager' : 'https://metager3.de/en/meta/meta.ger3?eingabe={}','dogpile' : 'https://www.dogpile.com/serp?q={}','etools' : 'https://www.etools.ch/searchSubmit.do?query={}','gigablast' : 'http://www.gigablast.com/search?c=main&qlangcountry=en-us&q={}','github' : 'https://github.com/search?q={}&ref=opensearch','libgen' : 'http://gen.lib.rus.ec/search.php?req={}&view=simple&res=25&phrase=1&column=def&page=1','peekier' : 'https://peekier.com/#!{}','qwant' : 'https://www.qwant.com/?q={}&client=opensearch','ga' : 'https://www.lukol.com/s.php?q=#gsc.tab=0&gsc.q={}&gsc.page=1','givero':'https://www.givero.com/search?q={}','ask':'https://www.ask.com/web?q={}','diskrete':'https://www.discretesearch.com/search?eq={}','searchencrypt':'https://www.searchencrypt.com/search/?q={}','swisscows':'https://swisscows.com/web?culture=ru&query={}&region=iv','libraries.io':'https://libraries.io/search?q={}','filcr':'https://www.flickr.com/search/?text={}','vimeo':'https://vimeo.com/search?q={}','youtube':'https://www.youtube.com/results?search_query={}','blogsearchengine':'http://www.blogsearchengine.org/search.html?q={}','searchcode':'https://searchcode.com/?q={}','social-searcher':'https://www.social-searcher.com/social-buzz/?q5={}'}
## Page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = ['http://localhost:37770/','http://localhost:37740/']
...
config.bind('П', 'scroll-to-perc')
config.bind('R', 'reload -f')
config.bind('К', 'reload -f')
config.bind('gg', 'scroll-to-perc 0')
config.bind('пп', 'scroll-to-perc 0')
...
config.bind('к', 'reload')

#Буфер обмена
config.bind(';y', 'hint links yank')
config.bind('жн', 'hint links yank')
config.bind(';Y', 'hint links yank-primary')
config.bind('жН', 'hint links yank-primary')
config.bind('pP', 'open -t -- {primary}')
config.bind('зЗ', 'open -t -- {primary}')
config.bind('pp', 'open -t -- {clipboard}')
config.bind('зз', 'open -t -- {clipboard}')
config.bind('PP', 'open -- {primary}')
config.bind('ЗЗ', 'open -- {primary}')
config.bind('Pp', 'open -- {clipboard}')
config.bind('Зз', 'open -- {clipboard}')
config.bind('yD', 'yank domain -s')
config.bind('нВ', 'yank domain -s')
config.bind('yM', 'yank inline [{title}]({url}) -s')
config.bind('нЬ', 'yank inline [{title}]({url}) -s')
config.bind('yP', 'yank pretty-url -s')
config.bind('нЗ', 'yank pretty-url -s')
config.bind('yT', 'yank title -s')
config.bind('нЕ', 'yank title -s')
config.bind('yY', 'yank -s')
config.bind('нН', 'yank -s')
config.bind('yd', 'yank domain')
config.bind('нв', 'yank domain')
config.bind('ym', 'yank inline [{title}]({url})')
config.bind('нь', 'yank inline [{title}]({url})')
config.bind('yp', 'yank pretty-url')
config.bind('нз', 'yank pretty-url')
config.bind('yt', 'yank title')
config.bind('не', 'yank title')
config.bind('yy', 'yank')
config.bind('нн', 'yank')
config.bind('wP', 'open -w -- {primary}')
config.bind('цЗ', 'open -w -- {primary}')
config.bind('wp', 'open -w -- {clipboard}')
config.bind('цз', 'open -w -- {clipboard}')

#Hints
config.bind(';I', 'hint images tab')
config.bind('жШ', 'hint images tab')
config.bind(';O', 'hint links fill :open -t -r {hint-url}')
config.bind('жЩ', 'hint links fill :open -t -r {hint-url}')
config.bind(';R', 'hint --rapid links window')
config.bind('жК', 'hint --rapid links window')
config.bind(';b', 'hint all tab-bg')
config.bind('жи', 'hint all tab-bg')
config.bind(';d', 'hint links download')
config.bind('жв', 'hint links download')
config.bind(';f', 'hint all tab-fg')
config.bind('жа', 'hint all tab-fg')
config.bind(';h', 'hint all hover')
config.bind('жр', 'hint all hover')
config.bind(';i', 'hint images')
config.bind('жш', 'hint images')
config.bind(';o', 'hint links fill :open {hint-url}')
config.bind('жщ', 'hint links fill :open {hint-url}')
config.bind(';r', 'hint --rapid links tab-bg')
config.bind('жк', 'hint --rapid links tab-bg')
config.bind(';t', 'hint inputs')
config.bind('же', 'hint inputs')
config.bind('F', 'hint all tab')
config.bind('А', 'hint all tab')
config.bind('f', 'hint')
config.bind('а', 'hint')
config.bind('wf', 'hint all window')
config.bind('ца', 'hint all window')


# Вкладки, история, переходы
config.bind('<Ctrl-T>', 'open -t')
config.bind('ga', 'open -t')
config.bind('пф', 'open -t')
...
config.bind('пЩ', 'set-cmd-text :open {url:pretty}')
config.bind('xO', 'set-cmd-text -s :open -b')
config.bind('чЩ', 'set-cmd-text -s :open -b')
#
config.bind('o', 'set-cmd-text -s :open -t')
config.bind('щ', 'set-cmd-text -s :open -t')
config.bind('go', 'set-cmd-text :open -t -r {url:pretty}')
config.bind('пщ', 'set-cmd-text :open -t -r {url:pretty}')
config.bind('xo', 'set-cmd-text :open -b -r {url:pretty}')
config.bind('чщ', 'set-cmd-text :open -b -r {url:pretty}')
#
config.bind('wo', 'set-cmd-text -s :open -w')
config.bind('цщ', 'set-cmd-text -s :open -w')
config.bind('wO', 'set-cmd-text :open -w {url:pretty}')
config.bind('цЩ', 'set-cmd-text :open -w {url:pretty}')
#
...
config.bind('Е', 'set-cmd-text -sr :tab-focus')
config.bind('g^', 'tab-focus 1')
config.bind('п:', 'tab-focus 1')
config.bind('gt', 'set-cmd-text -s :tab-select')
config.bind('пе', 'set-cmd-text -s :tab-select')
config.bind('g$', 'tab-focus -1')
config.bind('п;', 'tab-focus -1')
config.bind('g0', 'tab-focus 1')
config.bind('п0', 'tab-focus 1')
...
config.bind('Г', 'undo -w')
config.bind('<Ctrl-W>', 'tab-close')
config.bind('D', 'tab-close -o')
config.bind('В', 'tab-close -o')
config.bind('co', 'tab-only')
config.bind('сщ', 'tab-only')
config.bind('gC', 'tab-clone')
config.bind('пС', 'tab-clone')
config.bind('gD', 'tab-give')
config.bind('пВ', 'tab-give')
config.bind('gJ', 'tab-move +')
config.bind('пО', 'tab-move +')
config.bind('gK', 'tab-move -')
config.bind('пЛ', 'tab-move -')
config.bind('d', 'tab-close')
config.bind('в', 'tab-close')
config.bind('gm', 'tab-move')
config.bind('пь', 'tab-move')
config.bind('u', 'undo')
config.bind('г', 'undo')
#
...
config.bind('Ыр', 'history')
config.bind('H', 'back')
config.bind('Р', 'back')
config.bind('L', 'forward')
config.bind('Д', 'forward')
config.bind('th', 'back -t')
config.bind('ер', 'back -t')
config.bind('tl', 'forward -t')
config.bind('ед', 'forward -t')
config.bind('wh', 'back -w')
config.bind('цр', 'back -w')
config.bind('wl', 'forward -w')
config.bind('цд', 'forward -w')
#
config.bind('[[', 'navigate prev')      
config.bind('хх', 'navigate prev')      
config.bind(']]', 'navigate next')
config.bind('ъъ', 'navigate next')
config.bind('gu', 'navigate up')
config.bind('пг', 'navigate up')
config.bind('{{', 'navigate prev -t')
config.bind('ХХ', 'navigate prev -t')
config.bind('}}', 'navigate next -t')
config.bind('ЪЪ', 'navigate next -t')
config.bind('gU', 'navigate up -t')
config.bind('пГ', 'navigate up -t')
...
# Загрузки, печать, файлы
config.bind('<Ctrl-Alt-p>', 'print')
config.bind('ad', 'download-cancel')
config.bind('фв', 'download-cancel')
config.bind('cd', 'download-clear')
config.bind('св', 'download-clear')
config.bind('gd', 'download')
config.bind('пв', 'download')

# закладки и регистры
config.bind('b', 'set-cmd-text -s :quickmark-load -t')
config.bind('и', 'set-cmd-text -s :quickmark-load -t')
config.bind('B', 'set-cmd-text -s :quickmark-load')
config.bind('И', 'set-cmd-text -s :quickmark-load')
config.bind('gb', 'set-cmd-text -s :bookmark-load -t')
config.bind('пи', 'set-cmd-text -s :bookmark-load -t')
config.bind('gB', 'set-cmd-text -s :bookmark-load')
config.bind('пИ', 'set-cmd-text -s :bookmark-load')
config.bind('wB', 'set-cmd-text -s :bookmark-load -w')
config.bind('цИ', 'set-cmd-text -s :bookmark-load -w')
config.bind('wb', 'set-cmd-text -s :quickmark-load -w')
config.bind('ци', 'set-cmd-text -s :quickmark-load -w')
#
config.bind('M', 'bookmark-add')
config.bind('Ь', 'bookmark-add')
config.bind('m', 'quickmark-save')
config.bind('ь', 'quickmark-save')
config.bind('Sb', 'bookmark-list --jump')
config.bind('Ыи', 'bookmark-list --jump')
config.bind('Sq', 'bookmark-list')
config.bind('Ый', 'bookmark-list')

#Настройки
config.bind('Ss', 'set')
config.bind('Ыы', 'set')
config.bind('sk', 'set-cmd-text -s :bind')
config.bind('ыл', 'set-cmd-text -s :bind')
config.bind('sl', 'set-cmd-text -s :set -t')
config.bind('ыд', 'set-cmd-text -s :set -t')
config.bind('ss', 'set-cmd-text -s :set')
config.bind('ыы', 'set-cmd-text -s :set')
config.bind('sf', 'save')
config.bind('ыа', 'save')
#
config.bind('tCH', 'config-cycle -p -u *://*.{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('еСР', 'config-cycle -p -u *://*.{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('tCh', 'config-cycle -p -u *://{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('еСр', 'config-cycle -p -u *://{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('tCu', 'config-cycle -p -u {url} content.cookies.accept all no-3rdparty never ;; reload')
config.bind('еСг', 'config-cycle -p -u {url} content.cookies.accept all no-3rdparty never ;; reload')
config.bind('tIH', 'config-cycle -p -u *://*.{url:host}/* content.images ;; reload')
config.bind('еШР', 'config-cycle -p -u *://*.{url:host}/* content.images ;; reload')
config.bind('tIh', 'config-cycle -p -u *://{url:host}/* content.images ;; reload')
config.bind('еШр', 'config-cycle -p -u *://{url:host}/* content.images ;; reload')
config.bind('tIu', 'config-cycle -p -u {url} content.images ;; reload')
config.bind('еШг', 'config-cycle -p -u {url} content.images ;; reload')
config.bind('tPH', 'config-cycle -p -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('еЗР', 'config-cycle -p -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('tPh', 'config-cycle -p -u *://{url:host}/* content.plugins ;; reload')
config.bind('еЗр', 'config-cycle -p -u *://{url:host}/* content.plugins ;; reload')
config.bind('tPu', 'config-cycle -p -u {url} content.plugins ;; reload')
config.bind('еЗг', 'config-cycle -p -u {url} content.plugins ;; reload')
config.bind('tSH', 'config-cycle -p -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('еЫР', 'config-cycle -p -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('tSh', 'config-cycle -p -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('еЫр', 'config-cycle -p -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('tSu', 'config-cycle -p -u {url} content.javascript.enabled ;; reload')
config.bind('еЫг', 'config-cycle -p -u {url} content.javascript.enabled ;; reload')
config.bind('tcH', 'config-cycle -p -t -u *://*.{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('есР', 'config-cycle -p -t -u *://*.{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('tch', 'config-cycle -p -t -u *://{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('еср', 'config-cycle -p -t -u *://{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('tcu', 'config-cycle -p -t -u {url} content.cookies.accept all no-3rdparty never ;; reload')
config.bind('есг', 'config-cycle -p -t -u {url} content.cookies.accept all no-3rdparty never ;; reload')
config.bind('tiH', 'config-cycle -p -t -u *://*.{url:host}/* content.images ;; reload')
config.bind('ешР', 'config-cycle -p -t -u *://*.{url:host}/* content.images ;; reload')
config.bind('tih', 'config-cycle -p -t -u *://{url:host}/* content.images ;; reload')
config.bind('ешр', 'config-cycle -p -t -u *://{url:host}/* content.images ;; reload')
config.bind('tiu', 'config-cycle -p -t -u {url} content.images ;; reload')
config.bind('ешг', 'config-cycle -p -t -u {url} content.images ;; reload')
config.bind('tpH', 'config-cycle -p -t -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('езР', 'config-cycle -p -t -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('tph', 'config-cycle -p -t -u *://{url:host}/* content.plugins ;; reload')
config.bind('езр', 'config-cycle -p -t -u *://{url:host}/* content.plugins ;; reload')
config.bind('tpu', 'config-cycle -p -t -u {url} content.plugins ;; reload')
config.bind('езг', 'config-cycle -p -t -u {url} content.plugins ;; reload')
config.bind('tsH', 'config-cycle -p -t -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('еыР', 'config-cycle -p -t -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('tsh', 'config-cycle -p -t -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('еыр', 'config-cycle -p -t -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('tsu', 'config-cycle -p -t -u {url} content.javascript.enabled ;; reload')
config.bind('еыг', 'config-cycle -p -t -u {url} content.javascript.enabled ;; reload')
...
config.bind('па', 'view-source')
config.bind('wIf', 'devtools-focus')
config.bind('цШа', 'devtools-focus')
config.bind('wIh', 'devtools left')
config.bind('цШр', 'devtools left')
config.bind('wIj', 'devtools bottom')
config.bind('цШо', 'devtools bottom')
config.bind('wIk', 'devtools top')
config.bind('цШл', 'devtools top')
config.bind('wIl', 'devtools right')
config.bind('цШд', 'devtools right')
config.bind('wIw', 'devtools window')
config.bind('цШц', 'devtools window')
config.bind('wi', 'devtools')
config.bind('цш', 'devtools')
...
#keepassxc
config.bind('<Alt-Shift-u>', 'spawn --userscript qute-keepassxc --key andrij', mode='insert')
config.bind('pw', 'spawn --userscript qute-keepassxc --key andrij', mode='normal')

#translate
config.bind(',ts','spawn -o crow {primary}')
config.bind('беі','spawn -o crow {primary}')
config.bind(',tw','set-cmd-text -s :spawn -o crow')
config.bind('бец','set-cmd-text -s :spawn -o crow}')
